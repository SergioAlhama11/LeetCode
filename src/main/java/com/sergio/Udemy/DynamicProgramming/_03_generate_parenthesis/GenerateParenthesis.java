package com.sergio.Udemy.DynamicProgramming._03_generate_parenthesis;
...
public class GenerateParenthesis {
  ...
  private void generateParenthesis(int openLeft, int closeLeft, StringBuilder current, List<String> result) {
